/*
  Last changed Time-stamp: <2006-10-13 06:40:31 raim>
  $Id: integrateODEs.c,v 1.1 2006/10/13 05:21:27 raimc Exp $
*/
/* 
 *
...
main (int argc, char *argv[])
{
  ...
  x[0] = "C_cy"; 
  x0[0] = 0.0;
  ode[0] = "((150.0 * (3.8 - (0.2 * D_cy) - (0.2 * C_cy)) * (1.0 - (0.2 * C_cy))) - (9.0 * C_cy))";
  x[1] = "D_cy";
  x0[1] = 9.0;
  ode[1] = "(3.8 - (3.0 * D_cy) - (0.2 * D_cy) - (0.2 * C_cy))";
  ...
  /* creating odeModel */
  om = ODEModel_createFromODEs(ast, neq, 0, 0, x, x0);

  /* this could be an SBML model containing events */
  ODEModel_setEvents(om, NULL); 
