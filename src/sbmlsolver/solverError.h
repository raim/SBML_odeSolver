/*
  Last changed Time-stamp: <2007-09-20 01:08:45 raim>
  $Id: solverError.h,v 1.27 2007/09/20 01:16:14 raimc Exp $ 
*/
/* 
 *
  ...
  typedef enum errorCode
    {
      ...
      SOLVER_ERROR_THE_MODEL_CONTAINS_PIECEWISE = 10009,
      ...
      SOLVER_ERROR_AST_EVALUATION_FAILED_DISCRETE_DATA = 20108,
      ...
      /** 2X3XX - Adjoint Solver Failures */
       
      /** 2X4XX - Objective Function Failures */      
      SOLVER_ERROR_VECTOR_V_FAILED = 20401,
      SOLVER_ERROR_OBJECTIVE_FUNCTION_FAILED = 20402,
      SOLVER_ERROR_OBJECTIVE_FUNCTION_V_VECTOR_COULD_NOT_BE_CONSTRUCTED = 20403,
      ...
      SOLVER_ERROR_CANNOT_COMPILE_SENSITIVITY_NOT_COMPUTED = 30505,
