/*
  Last changed Time-stamp: <2008-10-09 20:50:49 raim>
  $Id: odeModel.h,v 1.50 2008/10/09 18:56:44 raimc Exp $ 
*/
/* 
 *
...
extern "C" {
  ...
  SBML_ODESOLVER_API int ODEModel_getNumJacobiElement(odeModel_t *);
