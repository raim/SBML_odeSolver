...
void callMathFunction (directCode_t *c, unsigned int fun) {
	unsigned int num;
...
void callFunction (directCode_t *code, unsigned int fun) {
	unsigned int num;
...
double getAST_Name(ASTNode_t *n, cvodeData_t *data) {
	int i, j;
	double found = 0, datafound, findtol=1e-5, result=0;
...
void generate (directCode_t *c, ASTNode_t *AST, cvodeData_t *data) {
...
void generateFunction(directCode_t *code, ASTNode_t *AST, cvodeData_t *data) {
