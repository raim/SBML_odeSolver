...
WINCVODE_API void *CVodeMalloc(integer N, RhsFn f, real t0, N_Vector y0, int lmm, int iter,
...
WINCVODE_API int CVode(void *cvode_mem, real tout, N_Vector yout, real *t, int itask);
